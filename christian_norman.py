...
for product in products:
    if product["stock"] > 0:
        ...
        if (highest_priced_product is None or product["price"] > highest_priced_product["price"]):
            highest_priced_product = product

print("Total value:", total_value)

if highest_priced_product is not None:
    print("Highest-priced in-stock product:",
          highest_priced_product["name"])
else:
